#' Simulating data set under nonGem scenario
#' @name nongemData
#' @import MASS
#' 
#' @description These are two functions for simulating data set under nonGem scenario.
#'
#' @param n A scalar indicating the number of observation for each treatment group
#' @param co A matrix of covariance structure for the predictors, if there is m predictors, 
...
#' @param beta A list of length 2 recording the coefficients of the predictors for those two treatment groups respectively
...
# 
#
#' @return Output of these two functions for the data generator under nonGem case is not the same,
...
#' @export
nongemData_inSample <- function(n,   
								co,
								r,   
								beta, 
								inter) 
{
    ...
    MM1 <- true_alpha(co, beta, pro1=NULL, pro, r=NULL, type="nu")
    MM2 <- true_alpha(co, beta, pro1, pro, r=NULL, type="de")
    MM3 <- true_alpha(co, beta, pro1, pro, r, type="F")
...
#' @rdname  nongemData
#' @export
nongemData_outSample <- function(n,   
								co,
								r,   
								beta, 
								inter) 
